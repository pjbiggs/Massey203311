...
**Please see the separate document -- "Access_to_RStudio_2026.pdf" -- that has been provided both as a Stream announcement and in the "Taiwhanga\|Labs" section on the Stream site for setting up your Massey RStudio environment. It can also be found directly at: [Access_to_RStudio_2026.pdf](https://stream.massey.ac.nz/pluginfile.php/6640538/mod_resource/content/4/Access_to_RStudio_2026.pdf). You must do this before you can do any work in this course.**
